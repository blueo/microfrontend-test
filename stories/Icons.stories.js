      ...
      <section class="sb__group">
        <div class="row">
          <div class="col">
            ...
            <p>To use new icons within your project add them to the <code>themes/app/src/icons</code> folder and use them with the mixin as shown below. You can also reference them using <code>#{$icon-path}/my-icon.svg</code>.</p>
            <p>To add them to this page, you will need to add a new row to <code>./stories/_icons.scss</code> and <code>./stories/Icons.stories.js</code> (this file).</p>
          </div>
        </div>
      </section>
