import TabGroup from "../themes/app/src/js/components/Tabs/TabGroup";
import TabItem from "../themes/app/src/js/components/Tabs/TabItem";

export default {
  title: "Components/Tabs"
}

export const WithMobileSelect = () => ({
  components: { TabGroup, TabItem },
  template: `
    <tab-group :preventLink="true">
      <tab-item name="Tabbed heading 1">
      ...
      <tab-item name="Tabbed heading 2">
      ...
      <tab-item name="Tabbed heading 3">
